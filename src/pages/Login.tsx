...
const Login = () => {
  ...
  const handleDemoLogin = (userType: "student" | "organization") => {
    setIsLoggingIn(true);
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: `You are now logged in as a demo ${userType} account.`,
      });
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              >
                {isLoggingIn ? "Loading..." : "Student Demo"}
              </button>
              <button
                ...
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700"
              >
                {isLoggingIn ? "Loading..." : "Organization Demo"}
              </button>
            </div>
          </div>
        </div>
