...
import { Plus, Database, Award, Users } from "lucide-react";

const Dashboard = () => {
  const { toast } = useToast();
  const userRole = UserRole.ORGANIZATION; // This will come from authentication
          ...
          {userRole === UserRole.STUDENT ? (
            ...
            <Tabs defaultValue="overview" className="w-full">
              ...
              <TabsContent value="contests">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">My Contests</h2>
                <p className="text-gray-600 dark:text-gray-400 mb-8">
                  Manage your CAD design competitions
                </p>
              </TabsContent>
